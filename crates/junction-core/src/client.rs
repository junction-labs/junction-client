use crate::{
    endpoints::EndpointIter,
    load_balancer::{BackendLb, EndpointGroup},
    xds::AdsClient,
    ConfigCache, Endpoint, EndpointAddress, Error, StaticConfig,
};
use junction_api::{
    backend::Backend,
...
/// the request based on the inputs.
#[derive(Debug, Clone)]
...
impl Client {
    ...
    /// multiple backends, use [`JUNCTION_SEED`][crate::rand].
    ///
